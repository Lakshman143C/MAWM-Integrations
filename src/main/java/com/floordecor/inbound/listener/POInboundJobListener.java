...
@Component
public class POInboundJobListener implements JobExecutionListener {
    private static final CustomLogger log =
            CustomLoggerFactory.getLogger(POInboundJobListener.class);
    ...
    @Qualifier("poSftpService") private SFTPService poSftpService;
